<div class="container-fluid">
  ...
  <?php 
    echo anchor(
        'administrator/perbekalan/input',
    ...
    <?php
    echo anchor(
        'administrator/perbekalan/print_form',
    ...
    <?php
    echo anchor(
        'administrator/perbekalan/excel',
  ...
  <tbody>
  	<?php $no=1; foreach($pmj as $k) : ?>
        ...
        <td onclick="javascript: return confirm('Yakin Hapus?')"><?php echo anchor('administrator/perbekalan/hapus/'.$k->no, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
  		</tr>
  	<?php endforeach; ?>
  </table>
  </tbody>
