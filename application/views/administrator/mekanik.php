<div class="container-fluid">
  ...
  <i class="fas fa-clipboard"></i> Kinerja Petugas Mekanikal Elektrikal
  </div>

  <?php 
    echo anchor(
        'administrator/mekanik/input',
  ...
  <tbody>
  	<?php $no=1; foreach($mekanik as $k) : ?>
        ...
        <td onclick="javascript: return confirm('Yakin Hapus?')"><?php echo anchor('administrator/mekanik/hapus/'.$k->no, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
  		</tr>
  	<?php endforeach; ?>
  </table>
  </tbody>
