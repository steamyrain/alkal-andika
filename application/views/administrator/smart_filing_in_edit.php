...
<div class="container-fluid" ng-app="myApp" ng-controller="appCtrl">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
       ...
       <h4 class="h3 mb-0 text-gray">  <i class="fas fa-clipboard"></i> Edit data (Surat Masuk) </h4>
    </div>
       </div>
    ...
    <div class="card" style="width: 50%;">
        <div class="card-body">
            ...
            <form id="my-form" method="POST" enctype="multipart/form-data"
                action="<?php echo base_url ('administrator/smart_filing_in/update_data_edit') ?>">

                <div class="form-group">
                    <label>Pengirim</label>
                    <input type="text" name="pengirim" value="<?=$smartfiling->pengirim?>" class="form-control" required="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_terima" class="form-control" value="<?=$smartfiling->tgl_terima?>" required="">
                </div>
