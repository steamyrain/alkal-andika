<div class="container-fluid">
  ...
  <i class="fas fa-clipboard"></i> Kinerja Pengemudi Operasional Lapangan
  </div>
  ...
  <?php 
    ...
    <?php
    echo anchor(
        'administrator/operator/print_form',
  ...
  <tbody>
  	<?php $no=1; foreach($operator as $k) : ?>
  		<tr>
        ...
        <td onclick="javascript: return confirm('Yakin Hapus?')"><?php echo anchor('administrator/operator/hapus/'.$k->no, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
  		</tr>
  	<?php endforeach; ?>
  </table>
  </tbody>
