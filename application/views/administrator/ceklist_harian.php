<div class="container-fluid" ng-app="myApp" ng-controller="appCtrl">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <i class="fas fa-clipboard"></i> E- Ceklist (Laporan Harian)
    </div>
  ...
  <!--   <table class="table table-bordered teble-striped"> -->
    ...
    <table id="data-tabel" class="table table-bordered table-striped">
      ...
      <?php $no =1;foreach ($laphar as $value): ?>
        <tr >
          <td><?= $no++; ?></td>
          <td> <a  class="btn btn-primary" href="<?=base_url('administrator/ceklist_harian/detail/'.$value->id_header)?>"><?= $value->tanggal; ?> <i class="fas fa-edit"></i></a></td>
          <td><?= $value->waktu; ?></td>
      ...
      <div class="modal-body">
          <div class="card shadow mb-4">
              ...
              <div class="collapse" id="collapseCardExample_1" style="">
                  <div class="card-body">
                      <form action="<?php echo base_url('administrator/Ceklist_harian/printpdfheader/') ?>" method="post">
