...
class ServiceHistoryModel extends CI_Model {
    ...
    public function getDTServiceHistoryRekap($data){
        $this->db->select('a.plate_number plate_number,e.service_name service_name,d.service_date service_date,f.subservice_name as service_unit,d.unit_total as unit_total,f.unit as unit_unit');
