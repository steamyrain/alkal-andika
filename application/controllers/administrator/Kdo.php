...
class Kdo extends CI_Controller {
    ...
    public function index() {
        $this->is_loggedIn();
        $this->is_admin();
        $kdo = $this->KdoModel->getKdoBrandCategory()->result();
        $data = [
            'kdo'=> $kdo
        ];
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/kdo',$data);
    ...
    public function input() {
        ...
        $brand = $brandQ->result();
        $jenisQ = $this->db->get('alkal_category_kdo');
        $jenis = $jenisQ->result();
        $data = [
            'brand'=>$brand,
            'jenis'=>$jenis
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/kdo_form',$data);
        $this->load->view('template_administrator/footer');
    }

    public function edit($kdoId) {
        $this->is_loggedIn();
        $this->is_admin();
        $brandQ = $this->db->get('alkal_brand');
        $brand = $brandQ->result();
        $jenisQ = $this->db->get('alkal_category_kdo');
        $jenis = $jenisQ->result();
        $record = $this->KdoModel->getKdoBrandCategoryWhere($kdoId)->row();
        $data = [
            'brand'=>$brand,
            'jenis'=>$jenis,
            'record'=>$record
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/kdo_edit',$data);
        $this->load->view('template_administrator/footer');
    }
    ...
    public function input_aksi(){
        ...
        if($this->form_validation->run() === FALSE) {
            ...
            $catId =($this->input->post('catId')=="")?NULL:$this->input->post('catId');
            ...
            redirect(base_URL('administrator/kdo'));
        }
    ...
    public function hapus_aksi() {
        ...
        redirect(base_URL('administrator/kdo'),'refresh');
    }
    
    // _rules function is a set of kdo_form specific 
    // validation rules
