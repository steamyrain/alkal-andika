...
function __construct(){
    ...
    public function index()
    {
        ...
        $this->load->view('administrator/perbekalan',$data);
    ...
    public function input()
    {
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/perbekalan_form',$data);
        $this->load->view('template_administrator/footer');
    }
        ...
        else 
        {
            ...
            if(!$this->upload->do_upload('dokumentasi')) {
                ...
                $this->session->set_flashdata('pesan',
                    ...
                    redirect('administrator/perbekalan');
            }
        }
    }
            /*
    ...
    $object->getActiveSheet()->setCellValue('H1', 'Dokumentasi');
        ...
        foreach ($data['pmj'] as $k) {
            ...
            $object->getActiveSheet()->setCellValue('F'.$baris, $k->lokasi);
            $object->getActiveSheet()->setCellValue('G'.$baris, $k->dokumentasi);
    ...
    public function update($no)
    {
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/perbekalan_update',$data);
        $this->load->view('template_administrator/footer');
    }
