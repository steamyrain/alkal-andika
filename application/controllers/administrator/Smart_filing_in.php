...
class Smart_filing_in extends CI_Controller {
    ...
    public function index() {
        $this->is_loggedIn();
        $this->is_admin();
        $data['smartfiling'] = $this->smart_filing_model->get_data()->result();
      
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/smart_filing_in',$data);
     ...
     public function tambah_data()
    {
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/smart_filing_in_form',$data);
        $this->load->view('template_administrator/footer');
    }
    ...
    public function tambah_data_aksi(){
        ...
        // }else{
                    ...
                    if($this->upload->do_upload('file_surat')){
                        ...
                        // echo "<pre>";
                        // print_r($data);
                        $insert =  $this->smart_filing_model->input_data($data);

                        if($insert){
                            
                            $this->session->set_flashdata('success','Data berhasil di simpan');
                            redirect('administrator/smart_filing_in');
                        }else{
            ...
            // $this->smart_filing_model->input_data($data);
     ...
     public function edit($id)
    {
        ...
        $data['smartfiling'] = $this->db->get_where('smart_filing_in',array(
            "id"=>$id
        ))->row();
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar');
        $this->load->view('administrator/smart_filing_in_edit',$data);
        $this->load->view('template_administrator/footer');
    }
...
{           
        ...
        if(!empty($_FILES['file_disposisi']['name'])){
            ...
            $pengirim   = $this->input->post('pengirim');
                        ...
                        $insert =  $this->db->update('smart_filing_in',$arr);
    ...
    function delete($id){
        $this->db->where('id',$id);
        $delete = $this->db->delete('smart_filing_in');
           if($delete){
