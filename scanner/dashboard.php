...
<div class="content-wrapper">
			...
			<div id="content-container">
				...
				<center><div class="well"><h1><span class="fa-stack fa-lg"><i class="fa fa-bug fa-stack-1x"></i><i class="fa fa-search fa-stack-2x text-danger"></i></span> Malware Scanner</h1></div></center>
